...
bool parseSearchArgs(int argc, const char **argv, std::string &input_file, std::string &output_file, std::string &query_file, std::string &algorithm, int &k, int &L, int &M, int &probes, std::string &metric, double &delta)
{
    bool validArgs = true;
    int i;
